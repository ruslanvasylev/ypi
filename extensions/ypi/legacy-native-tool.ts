...
const READ_ONLY_EXCLUDED_BUILTINS = ["bash", "edit", "write"];
...
export function registerLegacyNativeRlmQueryTool(pi: ExtensionAPI, runtime: YpiRuntime): void {
	...
	debug("__YPI_LEGACY_NATIVE_TOOL_REGISTERED__ rlm_query");
