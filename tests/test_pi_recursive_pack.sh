...
HAS_PI_SKILL="$(node -e "const p=require('$PKG_JSON');console.log((p.pi?.skills||[]).join(','))")"
...
assert_contains "manifest exposes bounded delegation skill" "./skills" "$HAS_PI_SKILL"
