...
meta={'condition_depth':depth,'exit_code':rc,'elapsed_seconds':round(elapsed,3),'calls':calls,'max_observed_child_depth':max_observed,'cost':round(cost,6),'tokens':tokens,'max_rss_kib':rss,'score':score}
